...
export default function AgentChat() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: "agent", text: "¡Hola! Soy el Agente Natillera On-Chain (#12). ¿En qué te puedo ayudar?" },
  ]);
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              ...
              <div>
                <div style={{ color: "#35D07F", fontWeight: 700, fontSize: "14px" }}>
                  Agente Natillera
                </div>
              ...
              >
                <div
                  style={{
                    ...
                    background: msg.role === "user" ? "#35D07F" : "rgba(255,255,255,0.08)",
          ...
          >
            ...
            <button
              ...
              style={{
                padding: "8px 14px",
                background: input.trim() ? "#35D07F" : "rgba(53,208,127,0.3)",
                border: "none",
                borderRadius: "8px",
                color: "#0a0f1a",
                fontWeight: 700,
